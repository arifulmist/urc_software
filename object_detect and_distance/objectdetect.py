...
face_model = cv2.CascadeClassifier('haarcascade_frontalface_default.xml')#pretrained
Distance_level = 0#initial distance
classNames = []
with open('coco.names','r') as f:
    classNames = f.read().splitlines()
print(classNames)#print name of ki detect kortechi
Colors = np.random.uniform(0, 255, size=(len(classNames), 3))#border color
...
ref_image = cv2.imread("human.jpg")
